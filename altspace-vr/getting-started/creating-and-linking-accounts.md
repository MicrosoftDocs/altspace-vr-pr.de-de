...
ms.date: 06/25/2021
ms.topic: article
keywords: Registrierung, Konto, Kontoerstellung, Kontoverknüpfung, Microsoft-Konten, häufig gestellte Fragen, Problembehandlung, 2D-Modus, VR-Modus, Benutzername, Anzeige, Name
ms.openlocfilehash: 213fcb788d99942aed0eccfc62b7d47221e93aa435349a12127d6d2e06463bd3
ms.sourcegitcommit: b248ba2a6da7d669b430581fc3a1544413b2e9c1
ms.translationtype: MT
ms.contentlocale: de-DE
ms.lasthandoff: 08/11/2021
ms.locfileid: "119127911"
---
# <a name="creating-and-linking-your-altspacevr-account"></a>Erstellen und Verknüpfen Ihres AltspaceVR-Kontos

## <a name="disclaimer-regarding-account-linking"></a>Haftungsausschluss zur Kontoverknüpfung

Unten sind die verschiedenen Möglichkeiten aufgeführt, wie Sie Ihr AltspaceVR-Konto erstellen und verknüpfen können.
...
Wenn Sie ein Konto mit MSA erstellt haben und kein AltspaceVR-Kennwort haben, melden Sie sich bei an, wechseln Sie zu Ihrem Profil, und klicken Sie dann auf "Abmelden und neues Kennwort https://www.altvr.com/ erhalten".
...
* Wenn Sie feststellen, dass Sie keine verbindung mit Ihrem Microsoft-Konto herstellen können, können Sie weiterhin mit Ihrem Benutzernamen und Kennwort zu AltspaceVR zurückkommen. Wählen Sie einfach die Schaltfläche "Mit AltspaceVR anmelden" aus.
...
* Übermitteln Sie Ihre Protokolle, wenn Probleme auft sind, indem Sie zum HAUPTMENÜ > EINSTELLUNGEN > SUPPORT > Hochladen **Protokolle.**
...
Nein, Ihr Benutzername kann den gleichen Anzeigenamen wie andere verwenden. Wenn Ihr Anzeigename als "Dave" oder "Maria" geschrieben werden soll, können Sie dies tun! Ihr Anzeigename kann auch Leerzeichen enthalten, in denen ein Benutzername in der Regel nicht ist.

**Ich kann mich mein Kennwort nicht merken. Wie kann ich es zurücksetzen?**

- Wenn Sie ein Kennwort Microsoft-Konto, können Sie dem Microsoft-Ablauf für die Kennwortzurücksetzung folgen, nachdem Sie den Anmeldevorgang mit der Schaltfläche "Bei Microsoft anmelden" gestartet haben. 
...
Um Ihren **Benutzernamen** oder Anzeigenamen zu ändern, melden Sie sich bei altvr.com an, wählen Sie oben rechts Ihr Profilsymbol, Benutzerprofil, Bearbeiten aus, und aktualisieren Sie Ihren Benutzernamen oder Anzeigenamen. 

*Hinweis: Sie können Ihren Benutzernamen nur einmal ändern. Danach müssen Sie ein Supportticket einreichen.*
...
Nein. Sie können ein Microsoft-Konto mit einer aktuellen E-Mail-Adresse auch dann einrichten, wenn es nicht bei Microsoft gehostet wird. (Beispiel: G-Mail, Yahoo usw.). Wenn Sie sich mit Microsoft-Anmeldeinformationen anmelden, die dieselbe E-Mail-Adresse wie Ihr klassisches AltspaceVR-Konto verwenden, werden Sie nach der Anmeldung aufgefordert, Ihr Konto zu verknüpfen. Befolgen Sie die Anweisungen, um sich bei Ihrem klassischen Konto anzumelden, und Ihre Altspace- und Microsoft-Konten werden für Sie verknüpft.

**Kostet dies Geld?**

Nein! Das Erstellen eines Microsoft-Kontos ist kostenlos. Die Verwendung von AltspaceVR ist ebenfalls kostenlos. Denken Sie daran, dass Ihr Microsoft-Konto mit anderen Produkten und Diensten verknüpft ist, sodass Sie es verwenden können, um Dinge außerhalb von AltspaceVR zu erwerben, z. B. Abonnements (z. B. Office 365) oder Sonderware (z. B. Minecraft Marketplace).

**Was geschieht, wenn ich Probleme beim Verknüpfen meiner Konten habe?**

Wenn Sie nicht weiterkommen, können Sie sich jederzeit an unseren [Helpdesk](https://help.altvr.com/hc/requests/new)wenden.

**Was geschieht, wenn ich mehrere AltspaceVR-Konten habe?**

Nur ein AltspsaceVR-Konto kann mit einem Microsoft-Konto verknüpft werden. Sie benötigen ein separates Microsoft-Konto für jedes altspaceVR-Konto, mit dem Sie eine Verbindung herstellen möchten.

**Was geschieht, wenn ich meine Anmeldedetails verlerne?**

Wenn Sie probleme beim Anmelden bei AltspaceVR haben, nachdem Sie eine Verbindung mit Ihrem Microsoft-Konto hergestellt haben, wenden Sie sich an unseren [Helpdesk.](https://help.altvr.com/hc/requests/new) Informationen zu Problemen bei der Anmeldung bei Ihrem Microsoft-Konto finden Sie [hier](https://support.microsoft.com/account-billing/when-you-can-t-sign-in-to-your-microsoft-account-475c9b5c-8c25-49f1-9c2d-c64b7072e735) oder [hier,](https://support.microsoft.com/account-billing/how-to-help-keep-your-microsoft-account-safe-and-secure-628538c2-7006-33bb-5ef4-c917657362b9) um eine Liste mit Tipps und Ressourcen zur Problembehandlung zu finden.

**Muss ich eine Verbindung mit meinem Microsoft-Konto herstellen?**

Keine Sorge, Sie haben zeit, das Update vorzunehmen. Die Integration des Microsoft-Kontos wird in Phasen durchgeführt. Im Laufe der Zeit sind einige der wichtigsten neuen Features, an denen wir arbeiten, jedoch nur für Personen verfügbar, die ihr AltspaceVR-Konto mit ihrem Microsoft-Konto verknüpft haben. Der Grund dafür ist, dass diese Features (z. B. Ticketereignisse) starke und stabile Sicherheitsmaßnahmen erfordern. Weitere Informationen finden Sie in unserem [Blog.](https://altvr.com/microsoft-account-integration)

**Was ist mit meinem Datenschutz und meinen Daten?**

Es gibt keine Änderungen an unseren [Nutzungsbedingungen](../community/terms-of-service.md) oder unserer [Datenschutzrichtlinie.](https://privacy.microsoft.com/privacystatement) Microsoft und AltspaceVR setzen sich weiterhin für den Schutz Ihrer Privatsphäre ein. Außerdem wird weiterhin sichergestellt, dass Sie die volle Kontrolle über Ihre Daten und Informationen behalten. Weitere Informationen zu den Kernprinzipien von Microsoft zum Datenschutz finden Sie [hier.](https://privacy.microsoft.com) Sie können auch ausführliche Informationen zu den personenbezogenen Daten anfordern, die Microsoft über Sie im Zusammenhang mit Ihrem Microsoft-Konto [hat.](https://www.microsoft.com/concern/privacyrequest-msa) Wenn Sie schließlich über ein aktives AltspaceVR-Konto verfügen, können Sie jederzeit eine Kopie Ihrer Daten anfordern und anfordern, dass Ihre Daten gelöscht werden.
