...
## <a name="how-to-create-an-account-on-altvrcom"></a>Erstellen eines Kontos auf altvr.com

1. Starten Sie einen Browser, und navigieren Sie zur [Seite](https://account.altvr.com/users/sign_in) Anmelden.
2. Wählen Sie "Bei Microsoft anmelden" aus.
3. Melden Sie sich mit Ihrem persönlichen Microsoft-Konto an, oder wählen Sie "Create one!" , um ein neues persönliches Microsoft-Konto zur Verwendung mit AltspaceVR zu erstellen.
4. Nachdem Sie den Anmeldevorgang für das Microsoft-Konto abgeschlossen haben, wird Ihr AltspaceVR-Konto erstellt, und Es wird eine Bestätigungsmeldung angezeigt.
...
Um Ihren **Benutzernamen** oder Anzeigenamen zu ändern, melden Sie sich bei altvr.com an, wählen Sie oben rechts Ihr Profilsymbol aus, Benutzerprofil, Bearbeiten, und aktualisieren Sie Ihren Benutzernamen oder Anzeigenamen. 
...
Ja, wir haben ein wenig neu korriert. Sie können Ihr Konto jetzt verwalten, & Konten im **Hauptmenü > Konto > wechseln.**
...
**Bedeutet dies, dass ich eine neue E-Mail-Adresse mit Outlook?**

Nein. Sie können ein Microsoft-Konto mit einer aktuellen E-Mail-Adresse einrichten, auch wenn es nicht bei Microsoft gehostet wird. (Beispiel: G-Mail, Yahoo und so weiter). Wenn Sie sich mit Microsoft-Anmeldeinformationen anmelden, die dieselbe E-Mail-Adresse wie Ihr klassisches AltspaceVR-Konto haben, werden Sie nach der Anmeldung aufgefordert, Ihr Konto zu verknüpfen. Befolgen Sie die Anweisungen, um sich bei Ihrem klassischen Konto zu anmelden, und Ihre Altspace- und Microsoft-Konten werden für Sie verknüpft.

**Kostet es Geld?**

Nein! Das Erstellen eines Microsoft-Kontos ist kostenlos. Die Verwendung von AltspaceVR ist ebenfalls kostenlos. Denken Sie daran, dass Ihr Microsoft-Konto mit anderen Produkten und Diensten verknüpft ist, sodass Sie es für Käufe außerhalb von AltspaceVR verwenden können, z. B. Abonnements (z.B. Office 365) oder Waren vom Minecraft Marketplace.

**Was passiert, wenn ich Probleme beim Verknüpfen meiner Konten habe?**

Wenn Sie nicht weiterkommen, können Sie sich jederzeit über den [Helpdesk an uns wenden.](https://help.altvr.com/hc/requests/new)

**Was passiert, wenn ich mehrere AltspaceVR-Konten habe?**

Es kann nur ein AltspsaceVR-Konto mit einem Microsoft-Konto verknüpft werden. Sie benötigen ein separates Microsoft-Konto für jedes altspaceVR-Konto, das Sie verbinden möchten.

**Was passiert, wenn ich meine Anmeldeinformationen vergisst?**

Wenn Sie Probleme beim Anmelden bei AltspaceVR haben, nachdem Sie eine Verbindung mit Ihrem Microsoft-Konto erstellt haben, wenden Sie sich an unseren [Helpdesk.](https://help.altvr.com/hc/requests/new) Wenn Sie Probleme bei der [](https://support.microsoft.com/account-billing/when-you-can-t-sign-in-to-your-microsoft-account-475c9b5c-8c25-49f1-9c2d-c64b7072e735) Anmeldung bei Ihrem Microsoft-Konto haben, besuchen Sie hier oder [hier](https://support.microsoft.com/account-billing/how-to-help-keep-your-microsoft-account-safe-and-secure-628538c2-7006-33bb-5ef4-c917657362b9) eine Liste mit Tipps und Ressourcen zur Problembehandlung.

**Muss ich eine Verbindung mit meinem Microsoft-Konto herstellen?**

Keine Sorge, Sie haben zeit, das Update zu machen. Wir werden die Integration des Microsoft-Kontos in Phasen durchlaufen. Im Laufe der Zeit stehen einige der wichtigsten neuen Features, an denen wir arbeiten, nur Personen zur Verfügung, die ihr AltspaceVR-Konto mit ihrem Microsoft-Konto verknüpft haben. Der Grund dafür ist, dass diese Features (z. B. Ticketereignisse) starke und stabile Sicherheitsmaßnahmen erfordern. Weitere Informationen finden Sie in unserem [Blog.](https://altvr.com/microsoft-account-integration)

**Wie sieht es mit meinem Datenschutz und meinen Daten aus?**

Es gibt keine Änderungen an unseren [Nutzungsbedingungen](../community/terms-of-service.md) oder unserer [Datenschutzrichtlinie.](https://privacy.microsoft.com/privacystatement) Microsoft und AltspaceVR sind weiterhin bestrebt, Ihre Privatsphäre zu schützen. Sie bleiben auch bei der Sicherstellung, dass Sie die vollständige Kontrolle über Ihre Daten und Informationen haben. Weitere Informationen zu den wichtigsten Prinzipien von Microsoft zum Datenschutz finden Sie [hier.](https://privacy.microsoft.com) Sie können auch ausführliche Informationen zu den personenbezogenen Daten anfordern, die Microsoft über Sie im Zusammenhang mit Ihrem Microsoft-Konto [hat.](https://www.microsoft.com/concern/privacyrequest-msa) Wenn Sie über ein aktives AltspaceVR-Konto verfügen, können Sie schließlich jederzeit eine Kopie Ihrer Daten anfordern und anfordern, dass Ihre Daten gelöscht werden.
