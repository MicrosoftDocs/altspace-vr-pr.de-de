...
Die Hosttools werden unten rechts im Ansichtsfeld angezeigt. Es steht Ihnen unmittelbar nach der Erstellung ihres Ereignisses zur Verfügung, sodass Sie Ihr Ereignis jederzeit eingeben können (die Startzeit des Ereignisses gilt nicht für die Hosts oder Moderatoren eines Ereignisses) und sich mit den Tools vor showtime vertraut machen können. Mit den Hosttools erhalten Sie Schnellklickzugriff auf Dinge wie "On-Air" (erforderlich für das Ausführen von FrontRow-Ereignissen), Muting und Messaging für Ihre Zielgruppe, Ein- und Ausschalten Ihrer Phasenblocker, Megafoning selbst, sodass Ihre Gäste ihre Hände "heben" können, um Fragen zu stellen oder Feedback zu geben, die Möglichkeit, von FrontRow Room in Room zu wechseln und vieles mehr.
...
Alle Benutzer mit der Rolle Host können diese Schaltfläche anzeigen. Wenn Sie auf Go On-Air klicken, wird Ihr Avatar in alle FrontRow-Räume "gespiegelt". Sobald Sie "Gespiegelt" sind, werden alle Ihre Meinung und Ihre Aktion in allen Instanzen Ihres FrontRow-Ereignisses angezeigt.
...
> [!NOTE]
> Wenn Sie sich erneut an Ihrem Ereignis anschließen müssen, wechseln Sie zu "Fire" und "Zurück", verlieren Sie ihre Internetverbindung, wechseln Sie von Raum zu Raum, und wenn Sie zurückkehren möchten, sind Sie NICHT in der Luft. Vergewissern Sie sich, dass Sie erneut auf Go On-Air klicken, sobald Sie wieder da sind.

### <a name="toggle-stage-blocker"></a>Stufenblocker umschalten
...
Versuchen Sie, jemanden mit ungültigen Audiodaten zu finden? Öffnen Sie Mics, um zu sehen, wer unveränderlich ist. Möchten Sie sicherstellen, dass alle benötigten Benutzer in Ihrem FrontRow-Ereignis gespiegelt sind? Wählen Sie On-Air (On-Air) aus, um alle Benutzer anzuzeigen, die derzeit in der Luft und gespiegelt sind. 

### <a name="moderation-tools"></a>Moderationstools

Als Ereignishost sind Sie für die Verwaltung der Erfahrungen anderer verantwortlich. Um effizient moderieren zu können, benötigen Sie und Ihre Moderatoren stabile Moderationstools. Als Host eines FrontRow-Ereignisses können Sie störende Personen stummschalten, Regel-Breakers (vorübergehend oder während Ihres Ereignisses) aus ihrem Ereignis herausholen und während des Ereignisses sogar anderen Benutzern die Rolle Moderator/Host zuweisen, um Hilfe bei der Verwaltung der Zielgruppe zu erhalten.

Sie können Gäste aus dem Gastbereich sofort stummschalten, indem Sie auf das Sprechersymbol neben ihrem Namen klicken oder das Hamburger-Menü auf der rechten Seite des Gastbereichs auswählen, um zusätzliche Optionen zu erhalten:
...
Jetzt können Sie Ihre FrontRow Hosting Magic-Funktion verwenden und diese Features für Ihre Teilnehmer verwenden:
    ...
    * **Megaphone:** Geben Sie ihnen die Möglichkeit, Meine Stimme zu verstärken.
    * **On-Air** : Sie können diesen Gast "spiegeln". Dadurch kann sein Avatar von allen In-Room-Ins in Ihrem FrontRow-Ereignis gesehen und gehört werden.
    * **Stufenzugriff:** Sie können alle Phasenblocker durchlaufen und in den Phasenbereich wechseln.
    * **Host erstellen:** Weist ihnen die Hostrolle in Ihrem FrontRow-Ereignis zu. Fügen Sie unterwegs eine Co-Host hinzu, stellen Sie sicher, dass sie ins Flugzeug gehen, und sie können Ihnen helfen, Dinge auszuführen, oder sie in die anderen Räume reisen lassen, um dinge zu überprüfen. Ist jeder in der Luft und wird in den sekundären Räumen angezeigt? Ist Ihre Präsentation für alle aktiven Räume synchron? Lassen Sie sie on-Air gehen, wenn sie sich im anderen Raum befinden, und Sie können Avatar mit Avatar von Raum zu Raum sprechen!
    ...
    * **Kick:** Regelunterbrechungen können vorübergehend oder während des Ereignisses aus dem Ereignis herausgelöscht werden.

## <a name="participation-panel"></a>Teilnahmebereich
 
Sie können diesen Bereich verwenden, um mit Ihren Ereignisteilnehmern zu interagieren. Sie können eine Q-&A erstellen, eine Warteschlange für ein Open Mic erstellen oder sicherstellen, dass der Gast, mit dem Sie sprechen, auch gespiegelt ist, sodass jeder von Ihnen in allen FrontRow-Räumen miteinander sprechen kann:
...
Wenn die Funktion "Hand löst Hand zulassen" aktiviert ist, wird im unteren rechten Abschnitt ihres Sichtfelds für alle Benutzer in Ihrem FrontRow-Ereignis die Schaltfläche "Hand auslösen" angezeigt:
...
Damit Sie den Überblick behalten, wird im Teilnahmebereich sogar eine rote Benachrichtigung angezeigt, wenn Gäste darauf warten, aufgerufen zu werden, und sie informiert Sie darüber, wie lange die einzelnen Gäste gewartet haben.

Jetzt können Sie sie aufrufen, indem Sie auf die Schaltfläche "On-Air + Megaphone" klicken. Dadurch wird die Schaltfläche nach der Aktivierung blau. Diese Aktion sendet zwei Nachrichten an den Hand Raiser, um zu bestätigen, dass er sein Mikrofon aufheben möchte und "Der Host hat sie aufgerufen und sie laut gemacht." Sobald sie akzeptieren, wird die Schaltfläche blau, und dadurch werden sie in der Luft "Gespiegelt" und "Amplify My Voice "Megaphoned" angezeigt, damit alle sehen und hören können!
...
Sie können ihnen auch temporären Stage-Zugriff gewähren oder rechts auf die Schaltfläche Alle verwerfen klicken, um die Liste der Hand Raiser vollständig zu löschen und neu zu starten.
...
*Beachten Sie, dass **(Sie sind hier)** angezeigt wird, d. h. den Raum, in dem Sie sich derzeit befinden.*
